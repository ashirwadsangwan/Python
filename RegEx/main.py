...
print(
    batty6 == None
)  # It represents that as woman doesn't appear in the string it will give None back.
...
"""
consonantReg = re.compile(
    r"[^aeiouAEIOU]"
)  # It's matching every chatacter that's not vowel.
...
print(
    startsWithHello.search("he said, Hello") == None
)  # because it doesn't start with Hello.
...
confidential = agentNamesReg.sub(
    r"\1****",
