...
print('The Euclidean Score is: {}'.format(sim_distance(critics, "Lisa Rose", "Gene Seymour")))
print('The Euclidean Score is: {}'.format(sim_distance(critics, "Lisa Rose", "Claudia Puig")))
print('The Euclidean Score is: {}'.format((sim_distance(critics, "Lisa Rose", "Michael Phillips"))))
...
print("The Pearon score is: {}".format(sim_pearson(critics, "Lisa Rose", "Gene Seymour")))
print("The Pearon score is: {}".format(sim_pearson(critics, "Lisa Rose", "Claudia Puig")))
print("The Pearon score is: {}".format(sim_pearson(critics, "Lisa Rose", "Michael Phillips")))
